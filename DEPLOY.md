...
3. Go to the **Actions** tab. Open the workflow **Deploy frontend to GitHub Pages** and confirm it ran after your push. When it succeeds, Pages shows your URL (for example `https://YOUR_USERNAME.github.io/YOUR_REPO/`).
